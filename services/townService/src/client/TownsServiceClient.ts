...
import { PokemonLocation, UserLocation, PokemonSpecies } from '../CoveyTypes';
import Pokemon from '../types/Pokemon';


export type ServerPlayer = { _id: string, _userName: string, location: UserLocation, pokemon: Pokemon[] };
